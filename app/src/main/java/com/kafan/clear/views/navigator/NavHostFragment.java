...
package com.kafan.clear.views.navigator;
...
public class NavHostFragment extends Fragment implements NavHost {
    ...
    public void onInflate(@NonNull Context context, @NonNull AttributeSet attrs,
        ...
        final TypedArray navHost = context.obtainStyledAttributes(attrs, androidx.navigation.fragment.R.styleable.NavHost);
        final int graphId = navHost.getResourceId(androidx.navigation.fragment.R.styleable.NavHost_navGraph, 0);
        if (graphId != 0) {
            mGraphId = graphId;
        }
        navHost.recycle();
