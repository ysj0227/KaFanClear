...
public class SingleTouchView extends View {
    ...
    private void init() {
        ...
        if (controlDrawable == null) {
            controlDrawable = getContext().getResources().getDrawable(R.drawable.search);
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isEditable) {
            ...
            controlDrawable.setBounds(
                    mControlPoint.x - mDrawableWidth / 2,
                    mControlPoint.y - mDrawableHeight / 2,
                    mControlPoint.x + mDrawableWidth / 2,
                    mControlPoint.y + mDrawableHeight / 2);
            ...
            if (deleteDrawable != null) {
                deleteDrawable.setBounds(
                        mDeletePoint.x - mDeleteDrawableWidth / 2,
                        mDeletePoint.y - mDeleteDrawableHeight / 2,
                        mDeletePoint.x + mDeleteDrawableWidth / 2,
                        mDeletePoint.y + mDeleteDrawableHeight / 2);
