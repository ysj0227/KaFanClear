...
import com.kafan.clear.databinding.ActivityCameraBinding
...
class CameraActivity : BaseActivity<ActivityCameraBinding>() {
    ...
    override fun initView() {
        ...
        mBinding.cameraFlash.setOnClickListener { openFlash() }
    }
    ...
    private fun openFlash() {
        ...
        cameraControl?.enableTorch(touchState != TorchState.ON)
    }
}
